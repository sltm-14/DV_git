...
set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { rstn }]; #IO_L7N_T1_AD2N_35 Sch=sw[0] # ---> sw[0]
...
#set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { rstn }]; #IO_L4N_T0_35 Sch=btn[1]  ----------->  btn[1]
