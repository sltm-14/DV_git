...
HD_PWD='C:/Users/c18560/Documents/Carem/DYV/TEST/UART/uart_new_test/uart_new_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log echo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source echo.tcl
