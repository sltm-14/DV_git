...
HD_PWD='C:/Users/c18560/Documents/Carem/DYV/TEST/UART/uart_new_test/uart_new_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log echo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source echo.tcl -notrace
