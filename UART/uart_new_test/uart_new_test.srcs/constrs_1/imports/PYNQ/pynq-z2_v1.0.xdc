...
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { clk }]; #---> sysclk

##Switches

#set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { swt }]; #IO_L7N_T1_AD2N_35 Sch=sw[0] # ---> sw[0]
#set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { in_en }]; #IO_L7P_T1_AD2P_35 Sch=sw[1]  # ---> sw[1]
...
#set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { out_Tx_Done }]; #IO_L22P_T3_AD7P_35 Sch=led5_g ---------> led5_g
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { out_Tx_Active }]; #IO_L23N_T3_35 Sch=led5_r ---------> led5_r

##LEDs

#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_L6N_T0_VREF_34 Sch=led[0]
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { led_1 }]; #IO_L6P_T0_34 Sch=led[1] -----------> led[1]
#set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { led_2 }]; #IO_L21N_T3_DQS_AD14N_35 Sch=led[2] -----------> led[2]
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { led_3 }]; #IO_L23P_T3_35 Sch=led[3] -----------> led[3]

##Buttons

#set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { btn[0] }]; #IO_L4P_T0_35 Sch=btn[0]
#set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { in_Btn }]; #IO_L4N_T0_35 Sch=btn[1]  ----------->  btn[1]
...
#set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { out_PWM_A }]; #IO_L17P_T2_34 Sch=ja_p[1] #---> ja[0]
#set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { out_Tx_Serial }]; #IO_L17N_T2_34 Sch=ja_n[1] #---> ja[1]
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { in_Rx_Serial }]; #IO_L7P_T1_34 Sch=ja_p[2]  #---> ja[2]
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { out_PWM_D }]; #IO_L7N_T1_34 Sch=ja_n[2]  #---> ja[3]
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { ja[4] }]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]
#set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { out_Tx_Serial }]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3] -------> ja[5]
#set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports {  in_Rx_Serial }]; #IO_L22P_T3_34 Sch=ja_p[4]      -------> ja[6]
...
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { out_Ts1 }]; #IO_L18P_T2_34 Sch=jb_p[3] ---- jb[4]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { tx }]; #IO_L18N_T2_34 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { rx }]; #IO_L4P_T0_34 Sch=jb_p[4]
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { out_Ts2 }]; #IO_L4N_T0_34 Sch=jb_n[4] ---- jb[7]
...
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { L[7] }]; #IO_L21N_T3_DQS_13 Sch=rpio_09_r -------------->  rpio_09_r
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { rpio_10_r }]; #IO_L15P_T2_DQS_13 Sch=rpio_10_r -------------->  rpio_10_r
#set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { L[6] }]; #IO_L16P_T2_13 Sch=rpio_11_r ------------------>  rpio_11_r
#set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports { rpio_12_r }]; #IO_L1N_T0_AD0N_35 Sch=rpio_12_r
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { leds[2] }]; #IO_L15N_T2_DQS_13 Sch=rpio_13_r -------------->  rpio_13_r
#set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { rpio_14_r }]; #IO_L22P_T3_13 Sch=rpio_14_r
#set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { leds[4] }]; #IO_L13N_T2_MRCC_13 Sch=rpio_15_r ------------->  rpio_15_r
#set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports { rpio_16_r }]; #IO_L2P_T0_AD8P_35 Sch=rpio_16_r
#set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { in_Rx_Serial }]; #IO_L11P_T1_SRCC_13 Sch=rpio_17_r # ----------> rpio_17_r
#set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports { rpio_18_r }]; #IO_L1P_T0_AD0P_35 Sch=rpio_18_r
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { leds[1] }]; #IO_L14N_T2_SRCC_13 Sch=rpio_19_r ------------>  rpio_19_r
...
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { out_Tx_Serial }]; #IO_L17N_T2_13 Sch=rpio_22_r # ----------> rpio_22_r
#set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { rpio_23_r }]; #IO_IO_L22N_T3_13 Sch=rpio_23_r
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { leds[3] }]; #IO_L13P_T2_MRCC_13 Sch=rpio_24_r ------------>  rpio_24_r
#set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports { rpio_25_r }]; #IO_L15N_T2_DQS_AD12N_35 Sch=rpio_25_r
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { leds[0] }]; #IO_L16N_T2_13 Sch=rpio_26_r ----------------->  rpio_26_r
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { L[5] }]; #IO_L7P_T1_34 Sch=rpio_sd_r ------------------>  rpio_sd_r
